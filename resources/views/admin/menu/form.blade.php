...
<div class="form-group">
    ...
    <div class="col-lg-8">
      <input type="text" class="form-control" name="url" id="url" value="{{old('url', $data->url ?? '')}}" required>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-lg-8">
      <input type="text" class="form-control" name="icono" id="icono" value="{{old('icono'), $data->icono ?? ''}}">
    </div>
